...
def save_model(model):
    model_path = MODELS_DIR / "scenario4_sac"
...
def save_metrics(evaluation_results, training_time):
    ...
    metrics_path = METRICS_DIR / "scenario4_sac.json"
...
def save_training_plot(callback):
    ...
    plt.title("Scenario 4 SAC Training Performance")
    ...
    plot_path = PLOTS_DIR / "scenario4_sac_training.png"
